...
import java.util.*;
/**
 * Converts a sparse file to scaled file. LibSVM utility code customized and integrated here for prototype <br>
 * Usage: <br>
...
public class svm_scale
{
	...
	private void output_target(int value)
	{
//		if(y_scaling)
//		{
//			if(value == y_min)
...
//		}
	...
	/**
	 * Usage:  -l &lt;lower range&gt; -s &lt;range file path&gt; &lt;file_name&gt;
				<br>
				csvToSparse -r &lt;range file path&gt; &lt;file_name&gt;
		Output File is saved at the same location as input but with an extension .scale		  
	 * @param argv
	 * @throws IOException
	 */
	public void run(String []argv) throws IOException
	{
		...
		//set the output to the file or standard output
		PrintStream original = System.out;
		System.setOut(new PrintStream(new FileOutputStream(data_filename+".scale")));
		...
		fp.close();
		System.out.println("Scaled File "+data_filename+".scale created.");
