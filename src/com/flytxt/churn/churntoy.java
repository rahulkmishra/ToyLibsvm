...
public class churntoy {
	...
	public static void main(String[] args) {
		...
		{	try {
				testModel(args[1], args[3], args[5]);
			} catch (IOException e) {
	...
	/**
	 * This method predict the class and generates statistics like confusion matrix, F-measure, Precision, recall, and accuracy
	...
	public static void testModel(String test_file, String model_file, String output_file) throws IOException
	{
		...
		double TP_count = 0, FP_count = 0, FN_count = 0, TN_count = 0;
		...
		double precision = TP_count/(TP_count+FP_count);
		double recall = TP_count/(TP_count+FN_count);
